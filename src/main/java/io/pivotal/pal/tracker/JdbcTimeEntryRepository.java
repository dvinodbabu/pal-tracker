...
public class JdbcTimeEntryRepository implements TimeEntryRepository {
    ...
    private RowMapper<TimeEntry> rowMapper = (rs, rowNumber) -> new TimeEntry(
            rs.getLong("id"),
    ...
    private ResultSetExtractor<TimeEntry> rowExtractor = rs -> rs.next() ? rowMapper.mapRow(rs, 1) : null;
}
